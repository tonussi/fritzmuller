  ...
  <v-card style="padding-top:60px;">
    ...
    <v-data-table
      ...
      <template slot="items" slot-scope="props">
        <td class="text-xs-center">{{ props.item.member_name }}</td>
        <td class="text-xs-center">{{ props.item.member_description.slice(0, 50) + ' ...' }}</td>
        <td class="text-xs-center">{{ props.item.grad }}</td>
